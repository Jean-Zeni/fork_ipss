...
class Configuracao extends Model
{
    ...
    {
        $whatsapp_mensagem = "Olá";
        $whats = preg_replace('/[^0-9]/i', '', '5182153223');
        $url = $this->isMobile()?"https://api.whatsapp.com/send?phone=55{$whats}":"https://web.whatsapp.com/send?phone=55{$whats}";

        if ($whatsapp_mensagem){
            $msg = urlencode($whatsapp_mensagem);
            return "{$url}&text={$msg}";
        }
