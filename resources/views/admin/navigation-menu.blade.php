        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-nav-link href="{{ route('pagina.index') }}" :active="request()->routeIs('admin.pagina')">
                        {{ __('Páginas') }}
                    </x-nav-link>
                    <x-nav-link href="{{ route('noticia.index') }}" :active="request()->routeIs('admin.noticia')">
                        {{ __('Notícias') }}
                    </x-nav-link>
                    <x-nav-link href="{{ route('banner.index') }}" :active="request()->routeIs('admin.banner')">
                        {{ __('Banners') }}
                    </x-nav-link>
                    <x-nav-link href="{{ route('reflexao.index') }}" :active="request()->routeIs('admin.reflexao')">
                        {{ __('Reflexões') }}
                    </x-nav-link>
                    ...
                    <x-nav-link href="{{ route('membro.index') }}" :active="request()->routeIs('admin.membro')">
                        {{ __('Membros') }}
                    </x-nav-link>
