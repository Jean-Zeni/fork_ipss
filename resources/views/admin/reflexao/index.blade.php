@section('titulo', 'Reflexões | Administrativo')
                        ...
                        <tbody>
                            @foreach ($reflexoes as $reflexao)
                                <tr>
                                    ...
                                    <td><?=$reflexao->membro->nome?></td>
                                    <th>{{ ($reflexao->ativo == 1) ? 'Sim' : 'Não' }}</th>
                                    <th>
                                        <a href="{{ route('reflexao.show', ['reflexao' => $reflexao->id]) }}">
                                    ...
                                    <th>
                                        <a href="{{ route('reflexao.edit', ['reflexao' => $reflexao->id]) }}">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                                stroke-width="1.5" stroke="currentColor" class="w-6 h-6 text-blue-600">
                                                <path stroke-linecap="round" stroke-linejoin="round"
                                    ...
                                    <th>
                                        <form action="{{ route('reflexao.destroy', ['reflexao' => $reflexao->id]) }}" method="POST"
