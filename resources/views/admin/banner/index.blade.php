@section('titulo', 'Banners | Administrativo')
                    ...
                    <table class="table table-striped table-bordered">
                        ...
                        <tbody>
                            @foreach ($banners as $banner)
                                <tr>
                                    <td>{{ $banner->titulo }}</td>
                                    <th>{{ ($banner->tipo_posicao == 'cap') ? 'Capa' : null  }}</th>
                                    <th>{{ ($banner->tipo_documento == 'IM') ? 'Imagem' : 'Vídeo' }}</th>
                                    <th>{{ $banner->ordem }}</th>
                                    <th>{{ ($banner->ativo == 1) ? 'Sim' : 'Não' }}</th>
                                    <th>
