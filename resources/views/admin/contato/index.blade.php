@section('titulo', 'Contato | Administrativo')
                        ...
                        <tbody>
                            @foreach ($contatos as $contato)
                                <tr>
                                    ...
                                    <td>{!! $contato->getStatusLabel() !!}</td>
                                    <th>
                                        <a href="{{ route('contato.show', ['contato' => $contato->id]) }}">
                                    ...
                                    <th>
                                        <a href="{{ route('contato.edit', ['contato' => $contato->id]) }}">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                                stroke-width="1.5" stroke="currentColor" class="w-6 h-6 text-blue-600">
                                                <path stroke-linecap="round" stroke-linejoin="round"
